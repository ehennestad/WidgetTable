    ...
    methods (Access = private) % Callbacks
        function onDataSet(comp)
            ...
            try
                ...
                % % hWaitbar = uihtml(comp.TablePanel);
                % % hWaitbar.HTMLSource = '/Users/Eivind/Code/MATLAB/Sandbox/Appdesign/Components/CSSLoaders/loaderC.html';
                % % hWaitbar.Position = [0,0,comp.TablePanel.Position(3:4)];
            catch
